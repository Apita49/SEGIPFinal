 ...
 */
@WebServlet("/Licencia_Registro")
public class RegistroLicencia extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		String text = fp
				.processFile("C:\\Paulo\\ProyectoIngSoft\\resources\\registroLicencia.php");
		writer.print(text);
	}
	...
	protected void doPost(HttpServletRequest request,
		...
		if (id != null && nacionalidad != null && fechaVenc != null
			...
			db.registrarLicencia(id, nacionalidad, fechaVenc, sexo,
					fechaEmision, grupoSanguineo, audifonos, lentes);
		}
		response.sendRedirect("http://localhost:8081/ProyectoIngSoft/Licencia_Registro");
	}
